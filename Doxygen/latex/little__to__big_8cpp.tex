...
\begin{DoxyCompactList}\small\item\em Passa uma word de little endian para big endian. \end{DoxyCompactList}\item 
...
o retorno eh a sequencia de bytes em big endian 
\end{DoxyReturn}
