...
\begin{DoxyCompactList}\small\item\em Esta é a classe mãe da J\+V\+M ela Ela quem deve encontrar a main da classe inicial e rodar o loop para rodar os métodos. Ela quem é responsável pela heap, e pela gerencia dos objetos alocados em geral inclusive os classfile! \end{DoxyCompactList}\end{DoxyCompactItemize}
